...
#'
#' \href{https://sheffield.ac.uk/nice-dsu/methods-development/mapping-eq-5d-5l-3l}{NICE DSU mapping website}.
#'
#' @name DSU3L
#' @export
"DSU3L"
...
#'   France, Germany, Hungary, Italy, Japan, Netherlands (2006), Netherlands (2026), 
#'   Pakistan, Poland, Portugal, Russia, Singapore, SouthKorea, Spain, SriLanka, 
#'   Sweden, Taiwan, Thailand, Trinidad and Tobago, Tunisia, UK, USA and Zimbabwe.
#'
#' @source
...
#' \item{\strong{Netherlands (2006)}: Lamers LM, McDonnell J, Stalmeier PF, Krabbe PF, Busschbach JJ. The Dutch tariff: results and arguments for an effective design for national EQ-5D valuation studies. Health Econ. 2006 Oct;15(10):1121-32. \doi{10.1002/hec.1124}. PMID: 16786549.}
#' \item{\strong{Netherlands (2026)}: Roudijk B, Jonker MF. Revisiting health state preferences after 20 years: A new EQ-5D-3L value set for the Netherlands. Eur J Health Econ. 2026 Jan 12. \doi{10.1007/s10198-025-01892-2}. PMID: 41525009.}
...
#' \item{\strong{Nigeria}: Yusuf AH, Ardo BU, Thavorncharoensap M, Roudijk B, Purba FD, Yang Z, Liao M, Chaikledkaew U, Youngkong S, Thakkinstian A, Agada-Amade YA, Amole TG, Sambo MN, Ohiri K. The EQ-5D-5L valuation study in Nigeria. Qual Life Res. 2026 Jun 15;35(8):206. \doi{10.1007/s11136-026-04319-4}. PMID: 42295458.}
...
#' \item{\strong{UK} Rowen D, Mukuria C, Bray N, Carlton J, Longworth L, Meads D, Oluboyede Y, O'Neill C, Yang Y. A UK value set for the EQ-5D-5L. Value Health. 2026 Mar 24:S1098-3015(26)00110-5. \doi{10.1016/j.jval.2026.03.008}. Epub ahead of print. PMID: 41887403.}
...
#'
#' EQ-5D-Y-3L value set calculation data for Australia, Belgium, Brazil, China, Germany, Hungary, 
#' Indonesia, Japan, Netherlands, Slovenia and Spain.
#'
#' @source
#'   \itemize{
#'     \item{\strong{Australia}: Pan T, Roudijk B, Devlin N, Mulhern B, Norman R. An Australian Value Set for the EQ-5D-Y-3L. Health Qual Life Outcomes. 2025 Jul 15;23(1):72. \doi{10.1186/s12955-025-02402-x}. PMID: 40660259.}
...
#'     \item{\strong{HongKong}: Wong EL, Wang K, Wong AY, Cheung AW, Wong CKH, Luo N, Rivero-Arias O, Yeoh EK. Value set of EQ-5D-Y-3L for Hong Kong. Health Qual Life Outcomes. 2026 Mar 23. \doi{10.1186/s12955-026-02522-y}. Epub ahead of print. PMID: 41872908.}
