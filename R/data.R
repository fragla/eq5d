...
#'
#' \strong{Ecuador}: Lucio R, Flores V,  Granja M, Mata G. Resultados de la encuesta de valoración social de los estados de salud de lAños de vida ajustados por calidad (QALY'S). 2019. \href{www.researchgate.net/publication/335840590_QALYs_FINAL_Ecuadordig}{Link}
#'
