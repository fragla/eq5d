...
test_that("single lss gives correct answer", {
  ...
  expect_equal(lss(c(MO=5,SC=5,UA=6,PD=5,AD=5), version="5L", ignore.invalid=TRUE), NA_integer_)
})
...
test_that("five digit lss gives correct answer", {
  ...
  expect_equal(lss(55575, version="5L", ignore.invalid=TRUE), NA_integer_)
...
test_that("lss returns NA for incorrect parameters when ignore.invalid=TRUE", {
  expect_equal(lss(12345, version="3L", ignore.invalid=TRUE),NA_integer_)
  expect_equal(lss(c(MO=1,SC=7,UA=3,PD=2,AD=1), version="3L", ignore.invalid=TRUE), NA_integer_)
})
