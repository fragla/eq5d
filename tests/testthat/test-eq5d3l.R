...
test_that("EQ-5D-5L Denmark TTO gives correct answer", {
...
test_that("EQ-5D-5L France TTO gives correct answer", {
...
test_that("EQ-5D-5L Germany TTO gives correct answer", {
...
test_that("EQ-5D-5L Korea TTO gives correct answer", {
...
test_that("EQ-5D-5L Netherlands TTO gives correct answer", {
...
test_that("EQ-5D-5L Spain TTO gives correct answer", {
...
test_that("EQ-5D-5L UK TTO gives correct answer", {
...
test_that("EQ-5D-5L USA TTO gives correct answer", {
...
test_that("EQ-5D-5L Zimbabwe TTO gives correct answer", {
...
test_that("EQ-5D-5L Belgium VAS gives correct answer", {
...
test_that("EQ-5D-5L Denmark VAS gives correct answer", {
...
test_that("EQ-5D-5L Europe VAS gives correct answer", {
...
test_that("EQ-5D-5L Finland VAS gives correct answer", {
...
test_that("EQ-5D-5L Germany VAS gives correct answer", {
...
test_that("EQ-5D-5L New Zealand VAS gives correct answer", {
...
test_that("EQ-5D-5L Slovenia VAS gives correct answer", {
...
test_that("EQ-5D-5L Spain VAS gives correct answer", {
...
test_that("EQ-5D-5L UK VAS gives correct answer", {
