...
test_that("Wrapper function gives correct answer", {
  ...
  expect_equal(eq5d(test.df2, country="Canada", version="5L", type="VT"), c(0.949,0.362,0.39,0.524,0.431))
  expect_equal(eq5d(test.df2, country="England", version="5L", type="VT"), c(1.000,0.393,0.434,0.488,0.400))
