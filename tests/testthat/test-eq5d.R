...
test_that("Wrapper function gives correct answer", {
  ...
  expect_equal(eq5d(c(MO=1,SC=2,UA=3,PD=4,AD=5), country="England_2018", version="5L", type="DSU", age=30, sex="female"), 0.067)
  expect_equal(eq5d(c(MO=2,SC=4,UA=1,PD=1,AD=2), country="England_2018", version="5L", type="DSU", age=50, sex="female"), 0.761)
  expect_equal(eq5d(c(MO=2,SC=3,UA=4,PD=2,AD=1), country="England_2018", version="5L", type="DSU", age=5, sex="male"), 0.609)
  expect_equal(eq5d(c(MO=1,SC=2,UA=3,PD=2,AD=1), country="England_2018", version="3L", type="DSU", age=30, sex="female"), 0.612)
  expect_equal(eq5d(c(MO=2,SC=2,UA=1,PD=1,AD=2), country="England_2018", version="3L", type="DSU", age=50, sex="female"), 0.712)
  expect_equal(eq5d(c(MO=3,SC=3,UA=3,PD=3,AD=3), country="England_2018", version="3L", type="DSU", age=3, sex="male"), -0.215)
  expect_equal(eq5d(c(MO=3,SC=3,UA=3,PD=3,AD=3), country="England_2018", version="3L", type="DSU", age=3, sex="male", digits = 8), -0.21529993)
  expect_equal(eq5d(0.922, country="England_2018", version="5L", type="DSU", age=18, sex="male"), 0.893)
  expect_equal(eq5d(0.435, country="England_2018", version="5L", type="DSU", age=30, sex="female", bwidth = 0.0001), 0.302)
  expect_equal(eq5d(0.922, country="England_2018", version="5L", type="DSU", age=18, sex="male"), 0.893)
  expect_equal(eq5d(-0.594, country="England_2018", version="3L", type="DSU", age=95, sex="female"), -0.209)
  expect_equal(eq5d(-0.002, country="England_2018", version="3L", type="DSU", age=50, sex="male", bwidth=0.1), 0.312)
  expect_equal(eq5d(0.715, country="England_2018", version="5L", type="DSU", age=50, sex="male", bwidth = 0.0001), 0.670)
  expect_equal(eq5d(0.715, country="England_2018", version="5L", type="DSU", age=50, sex="male", bwidth = 0.0001, digits = 7), 0.6701727)
  expect_equal(eq5d(0.715, country="England_2018", version="5L", type="DSU", age=50, sex="male", bwidth = 0.0001, ignore.invalid = TRUE, digits = "two"), NA)
  expect_equal(eq5d(0.435, country="England_2018", version="5L", type="DSU", age=30, sex="female", bwidth = 0.0001), 0.302)
  expect_equal(eq5d(0.95, country="England_2018", version="5L", type="DSU", age=70, sex="male", bwidth = 0.0001), 0.935)
  expect_equal(eq5d(0.715, country="England_2018", version="5L", type="DSU", age=50, sex="male", bwidth = 0.1), 0.637)
  expect_equal(eq5d(0.435, country="England_2018", version="5L", type="DSU", age=30, sex="female", bwidth = 0.1), 0.297)
  expect_equal(eq5d(0.95, country="England_2018", version="5L", type="DSU", age=70, sex="male", bwidth = 0.1), 0.844)
  expect_equal(eq5d(test.df4,version="5L", type="DSU", country="England_2018", age="age", sex="sex"), c(0.067,0.761,0.609))
  expect_equal(eq5d(test.df5,version="5L", type="DSU", country="England_2018", bwidth="bandwidth", utility="Utility"), c(0.893,0.353,-0.409,0.297))
  expect_equal(eq5d(test.df6,version="5L", type="DSU", country="England_2018", ignore.invalid = TRUE), c(-0.427,NA))
  expect_equal(eq5d(test.df7,version="5L", type="DSU", country="England_2018", bwidth=0.1), c(0.637,0.297,0.844))
  expect_equal(eq5d(test.df7,version="5L", type="DSU", country="England_2018", bwidth=0.0001), c(0.670,0.302,0.935))
  expect_equal(eq5d(0.715, country="England_2018", type="DSU", version="5L", age=50, sex="m", bwidth=0.1), 0.637)
  expect_equal(eq5d(0.715, country="England_2018", type="DSU", version="5L", age=50, sex="m", bwidth=0.0001), 0.670)
...
test_that("eq5d throws error for incorrect parameters", {
  ...
  expect_error(eq5d("12345", version="10L", type="VT", country="England_2018"))
  expect_error(eq5d(10000, version="5L", type="VT", country="England_2018"))
  expect_error(eq5d(99999, version="5L", type="VT", country="England_2018"))
  expect_error(eq5d(0.375, country="England_2018", version="5L", type="DSU", age=50, sex="male", bwidth=-0.00001))
  expect_error(eq5d(test.df7,version="5L", type="DSU", country="England_2018", bwidth=c(0.0001, 0.1)))
})
...
test_that("when ignore.invalid flag is TRUE the correct answer is returned", {
  ...
  expect_equal(eq5d(0.923, country="England_2018", version="5L", type="DSU", age=50, sex="male", bwidth=0, ignore.invalid=TRUE), NA)
  expect_error(eq5d(c(MO=1,SC=2,UA=3,PD=2,AD=6), version="5L", type="DSU", country="England_2018", age=23, sex="male", ignore.invalid=TRUE), NA)
  expect_error(eq5d(c(MO=1,SC=2,UA=3,PD=2,AD=6), version="3L", type="DSU", country="England_2018", age=23, sex="male", ignore.invalid=TRUE), NA)
...
test_that("when ignore.invalid flag is FALSE the correct answer is returned", {
  ...
  expect_error(eq5d(3.5, country="England_2018", version="5L", type="DSU", age=50, sex="male", bwidth=0.00001))
  ...
  expect_error(eq5d(0.923, country="England_2018", version="5L", type="DSU", age=50, sex="male", bwidth=0))
  expect_error(eq5d(0.715, country="England_2018", version="5L", type="DSU", age=50, sex="male", bwidth = 0.0001, digits = "two"))
