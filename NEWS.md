...
- Dutch EQ-5D-3L value set added. There are now two EQ-5D-3L value sets,
  the original 2006 value set and the new 2026 value set.

# eq5d 0.16.1 (2025-09-10)

- Singaporean EQ-5D-5L value set added.

- Australian EQ-5D-Y-3L value set added.

- Type for EQ-5D-Y-3L renamed to “IVP” (International Valuation
  Protocol).
