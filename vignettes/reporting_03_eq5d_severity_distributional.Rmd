...
shows EQ-5D-5L utility values calculated using the UK value set plotted against 
LSS, with the lowest, median, and highest utility values 
shown for each severity category.
